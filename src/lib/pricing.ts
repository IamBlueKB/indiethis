...
export const PRICING_DEFAULTS = {
  ...
  AI_MASTERING_STANDARD:     { value: 7.99,  display: "$7.99"   },
  AI_MASTERING_PREMIUM:      { value: 14.99, display: "$14.99"  },
  AI_MASTERING_PRO:          { value: 24.99, display: "$24.99"  },
  AI_MASTERING_SUB_LAUNCH_S: { value: 5.99,  display: "$5.99"   },
  AI_MASTERING_SUB_LAUNCH_P: { value: 11.99, display: "$11.99"  },
  AI_MASTERING_SUB_LAUNCH_X: { value: 19.99, display: "$19.99"  },
  AI_MASTERING_SUB_PUSH_S:   { value: 4.99,  display: "$4.99"   },
  AI_MASTERING_SUB_PUSH_P:   { value: 9.99,  display: "$9.99"   },
  AI_MASTERING_SUB_PUSH_X:   { value: 14.99, display: "$14.99"  },
  AI_MASTERING_SUB_REIGN_S:  { value: 3.99,  display: "$3.99"   },
  AI_MASTERING_SUB_REIGN_P:  { value: 7.99,  display: "$7.99"   },
  AI_MASTERING_SUB_REIGN_X:  { value: 9.99,  display: "$9.99"   },
