...
export default function StudioMerchPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Studio Merch</h1>
          <p className="text-sm text-muted-foreground mt-0.5">Sell branded merch from your studio store</p>
        </div>
        <Link
        ...
        <div className="rounded-xl border overflow-hidden" style={{ borderColor: "var(--border)" }}>
          {loadingProducts ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="text-xs text-muted-foreground mb-4">Add your studio logo to branded merch</p>
